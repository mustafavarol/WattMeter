#line 1 "D:/alinacak/PRJELER/ktowattmeter/program/MyProject.c"
...
void main() {
 ...
 AvgAcs=Samples/200;
 AcsValueF = (2.47 - (AvgAcs * (5.0 / 1023.0)) )/0.066;
 delay_ms(10);
 hesap = ADC_Read(1);
 ...
 Lcd_Cmd(_LCD_CLEAR);
 if(AcsValueF<1.0 && AcsValueF>0.0) {Lcd_Out(1,15,"m");}
 if(AcsValueF<0.1 && AcsValueF>0.0) {Lcd_Out(1,15,"r");}
 Lcd_Out(1,1,"V:");
 Lcd_Out(1,8,"A:");
 Lcd_Out(2,1,"W:");
 ...
 delay_ms(5);
 Lcd_Out(1,3,voltaj);
 FloatToStr_FixLen(AcsValueF, m,4);
 delay_ms(5);
 Lcd_Out(1,10,m);
